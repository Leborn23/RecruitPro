...
assert.equal(deriveProctoringSeverity('head_turned_right', 2999), 'low');
...
assert.equal(shouldOpenTimedEvent('head_turned_left', 2999), false);
assert.equal(shouldOpenTimedEvent('head_turned_left', 3000), true);
